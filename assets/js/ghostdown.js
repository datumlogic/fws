...
window.CodeMirror = (function() {
  ...
  function CodeMirror(place, options) {
    ...
    if (options.lineWrapping)
      this.display.wrapper.className += " CodeMirror-wrap form-control";
...
(function ($, ShowDown, CodeMirror) {
  ...
  $(function() {
    ...
    var converter = new ShowDown.converter(),
	 ...
	 var converter = new ShowDown.converter(),
        editor = CodeMirror.fromTextArea(document.getElementsByClassName('versiontextarea')[0], {
            mode: 'markdown',
            tabMode: 'indent',
            lineWrapping: true
        });
    ...
    function updatePreview() {
		// multiple text areas on the same page
		if(viewPage && viewPage ==true){
			$('.versiontextarea').each(function(index,value){	
				var thisClass = $(this).attr('id');
				var converter = new ShowDown.converter(),
				editor = CodeMirror.fromTextArea(document.getElementById(thisClass), {
					mode: 'markdown',
					tabMode: 'indent',
					lineWrapping: true
				});
				var preview = document.getElementsByClassName('rendered-markdown')[index];
